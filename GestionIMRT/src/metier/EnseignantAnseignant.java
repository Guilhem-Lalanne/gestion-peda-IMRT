 ...
 * 
 */
public class EnseignantAnseignant extends Personne{
  ...
  * @param mail 
  */
    public EnseignantAnseignant(int idDiscipline, String profession, int idEmployeur, Boolean docAdmPhotoCarteNat, Boolean docAdmPhotoCarteSecu, Boolean docAdmJustTrav, Boolean docAdmRecepArreteNomin, String nom, String prenom, String dateNaissance, String adresse, String numeroTelFixe, String numeroTelMobile, String mail) {
